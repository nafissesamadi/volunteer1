    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_active_code', models.CharField(blank=True, max_length=100, null=True, verbose_name='Email Activation code')),
                ('mobile_verification_code', models.CharField(blank=True, default='', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('national_code', models.CharField(blank=True, max_length=10, null=True, unique=True, verbose_name='Code Melli')),
        ...
        migrations.AddField(
            model_name='city',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='state', to='account.province'),
        ),
        migrations.AddField(
            model_name='user',
            name='user_type',
